...
#include <vector>
  ...
  class LYSO
  {
    ...
    // Optical Properties of Materials ( nm/1242.38 )
        ...
        int n5 = 6;
        G4double PhotonEnery[n5+1] = { 511000 * eV, 3.105 * eV,2.95714 * eV,2.855 * eV,2.7 * eV,2.5875 * eV,2.388 * eV };
        G4double att_lengh_ej[n5+1] = {1.2*cm, 400 * cm,400 * cm,400 * cm,400 * cm,400 * cm,400 * cm };
        ...
        fLYSO_MPT->AddProperty("ABSLENGTH", PhotonEnery, att_lengh_ej, n5 + 1);
